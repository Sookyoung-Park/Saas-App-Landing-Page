    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowarp border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            ...
            <ul className='relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden'>
              ...
              {details.map(({id, icon, title}) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  {/* <div className='aboslute top-8 bottom-0 left-1/2 bg-s3/20 w-[1px] h-full z-10' /> */}

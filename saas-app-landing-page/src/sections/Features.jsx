    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowarp lg:mt-40 xl:mt-40 border-2 border-s5/10 rounded-7xl md:overflow-hidden max-md:flex-col feature-after max-md:border-none max-md:rounded-none max-md:gap-3">
            ...
            <ul className='relative flex justify-around flex-grow px-[5%] border-2 border-s3/10 rounded-7xl max-md:hidden'>
              ...
              {details.map(({id, icon, title}) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                    <div className='flex items-center justify-center mx-auto mb-3 border-2 border-s3/10 rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-20'>
                      <img 
                      src={icon} 
                      alt={title}
